...
@section('isihalaman')
    <h3><center>Daftar Buku Di Perpustakan abal abal Andy</center></h3>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form name="formbukuedit" id="formbukuedit" action="/buku/edit/{{ $bk->id_buku}} " method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="container">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="selectKat" class="form-select" aria-label="Default select example" id="kategori" name="kategori" value="{{ $bk->kategori}}">
                                                </div>
                                            </div>
                ...
                <div class="modal-body">
                    <form name="formbukutambah" id="formbukutambah" action="/buku/tambah " method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="kategori" class="col-sm-4 col-form-label">Kategori</label>
                            <div class="col-sm-8">
                                <select class="form-control" arta-label="Default select example">
